        ...
        function(req, email, password, done) {
            ...
            User.findOne({ 'info.email' :  email }, function(err, user) {
                ...
                if (user) {
                    ...
                    newUser.info.imgSrc   = '/images/avatar/avatar' + getRandomInt(1,9) + '.png'; //random select picture from avatar pool
        ...
        function(req, email, password, done) { // callback with email and password from our form
            ...
            User.findOne({ 'info.email' :  email }, function(err, user) {
                ...
                if (!user)
                    ...
                    return done(null, false); // if not user find, just return default 401 by passport
